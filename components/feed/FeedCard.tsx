    ...
    <article className={`bg-white dark:bg-gray-800 rounded-lg border p-4 transition-colors ${
      ...
      <div className="flex items-start justify-between gap-3 mb-2">
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {feed.authorName && (
            <span className="text-sm text-gray-500 dark:text-gray-400">{feed.authorName}</span>
          )}
        </div>
      ...
      {feed.repoUrl && feed.repoName && (
        <div className="mt-2 flex items-center gap-1">
          <svg className="w-3.5 h-3.5 text-gray-400 dark:text-gray-500" fill="currentColor" viewBox="0 0 24 24">
